...
let
  sources = {
    ...
    "lru-cache-7.18.0" = {
      ...
      version = "7.18.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/lru-cache/-/lru-cache-7.18.0.tgz";
        sha512 = "zB4mTJNwserMxerHY0evAuBe/5wnyeznwZ6h19vTV3B9lbqm2c7pWlExjjXgBx8E2J64JF4siGBqKksl2cHTgg==";
      };
    };
    "make-dir-3.1.0" = {
      name = "make-dir";
