...
let
  sources = {
    ...
    "@types/node-18.7.10" = {
      ...
      version = "18.7.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-18.7.10.tgz";
        sha512 = "SST7B//wF7xlGoLo1IEVB0cQ4e7BgXlDk5IaPgb5s0DlYLjb4if07h8+0zbQIvahfPNXs6e7zyT0EH1MqaS+5g==";
      };
    };
    "JSV-4.0.2" = {
      name = "JSV";
