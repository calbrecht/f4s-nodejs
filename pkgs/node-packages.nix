...
let
  sources = {
    ...
    "electron-to-chromium-1.3.679" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.3.679";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.679.tgz";
        sha512 = "PNF7JSPAEa/aV2nQLvflRcnIMy31EOuCY87Jbdz0KsUf8O/eFNGpuwgQn2DmyJkKzfQb0zrieanRGWvf/4H+BA==";
      };
    };
    "emoji-regex-7.0.3" = {
      name = "emoji-regex";
    ...
    "es-abstract-1.18.0-next.3" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/es-abstract/-/es-abstract-1.18.0-next.3.tgz";
...
in
{
  ...
  import-js = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.3.679"
  ...
  standardx = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."es-abstract-1.18.0-next.3"
