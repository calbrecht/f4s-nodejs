...
let
  sources = {
    ...
    "@types/node-14.14.39" = {
      ...
      version = "14.14.39";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-14.14.39.tgz";
        sha512 = "Qipn7rfTxGEDqZiezH+wxqWYR8vcXq5LRpZrETD19Gs4o8LbklbmqotSUsMU+s5G3PJwMRDfNEYoxrcBwIxOuw==";
      };
    };
    "JSV-4.0.2" = {
      name = "JSV";
