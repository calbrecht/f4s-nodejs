...
let
  sources = {
    ...
    "@types/node-17.0.39" = {
      ...
      version = "17.0.39";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-17.0.39.tgz";
        sha512 = "JDU3YLlnPK3WDao6/DlXLOgSNpG13ct+CwIO17V8q0/9fWJyeMJJ/VyZ1lv8kDprihvZMydzVwf0tQOqGiY2Nw==";
      };
    };
    "JSV-4.0.2" = {
      name = "JSV";
