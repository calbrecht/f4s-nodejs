...
let
  sources = {
    ...
    "sqlite3-5.1.5" = {
      ...
      version = "5.1.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/sqlite3/-/sqlite3-5.1.5.tgz";
        sha512 = "7sP16i4wI+yKnGOO2q2ijze7EjQ9US+Vw7DYYwxfFtqNZDGgBcEw0oeDaDvUTq66uJOzVd/z6MkIg+c9erSJKg==";
      };
    };
    "sshpk-1.17.0" = {
      name = "sshpk";
