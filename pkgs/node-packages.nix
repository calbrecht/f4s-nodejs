...
in
{
  ...
  intelephense = nodeEnv.buildNodePackage {
    ...
    version = "1.11.4";
    src = fetchurl {
      url = "https://registry.npmjs.org/intelephense/-/intelephense-1.11.4.tgz";
      sha512 = "9XdcgDfnr8/PZ8aYrGDG6eLfzB+N/qtmJqBQADGJGHWoDOE0ZB+ODu+wvgx42Ijtapj3LpeOon67Rd5K0YUr5A==";
    };
    dependencies = [
