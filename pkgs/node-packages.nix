...
let
  sources = {
    ...
    "@types/node-18.7.3" = {
      ...
      version = "18.7.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-18.7.3.tgz";
        sha512 = "LJgzOEwWuMTBxHzgBR/fhhBOWrvBjvO+zPteUgbbuQi80rYIZHrk1mNbRUqPZqSLP2H7Rwt1EFLL/tNLD1Xx/w==";
      };
    };
    "JSV-4.0.2" = {
      name = "JSV";
...
in
{
  ...
  typescript-language-server = nodeEnv.buildNodePackage {
    ...
    version = "1.0.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/typescript-language-server/-/typescript-language-server-1.0.0.tgz";
      sha512 = "5T7YSHCP4qXOg5j6dzm7H1r9V7RGxKtc5DMpdVPOCaiprPxpNUqJqPPcZB0sJDPKFSuCPhRfG/fg+sLuso5Z3Q==";
    };
    dependencies = [
