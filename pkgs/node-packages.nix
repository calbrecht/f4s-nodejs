...
in
{
  ...
  intelephense = nodeEnv.buildNodePackage {
    ...
    version = "1.11.6";
    src = fetchurl {
      url = "https://registry.npmjs.org/intelephense/-/intelephense-1.11.6.tgz";
      sha512 = "0dOkR1xf7I9rTMoiexlNENQ58hnQEeUG/isM/EBQt9DBVFb6rJvEB7nnioc/BMWfxYlwS+dcZEus0GPF3JY6Vw==";
    };
    dependencies = [
