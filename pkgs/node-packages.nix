...
let
  sources = {
    ...
    "@types/minimatch-5.1.1" = {
      ...
      version = "5.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/minimatch/-/minimatch-5.1.1.tgz";
        sha512 = "v55NF6Dz0wrj14Rn8iEABTWrhYRmgkJYuokduunSiq++t3hZ9VZ6dvcDt+850Pm5sGJZk8RaHzkFCXPxVINZ+g==";
      };
    };
    "@types/node-13.13.52" = {
