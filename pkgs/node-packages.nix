...
in
{
  ...
  intelephense = nodeEnv.buildNodePackage {
    ...
    version = "1.11.7";
    src = fetchurl {
      url = "https://registry.npmjs.org/intelephense/-/intelephense-1.11.7.tgz";
      sha512 = "o8GqM418AxfJbAH0NTmJYKmktlpV2Zd5zZ+lk5PSLS1zLB414F1UVNpZ5LlmrlA6iRPBFVXHnQpn72AMuqOaiw==";
    };
    dependencies = [
