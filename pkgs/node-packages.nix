...
let
  sources = {
    ...
    "@babel/runtime-7.22.0" = {
      ...
      version = "7.22.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@babel/runtime/-/runtime-7.22.0.tgz";
        sha512 = "TT6NB0oszYQ4oxLNUdG+FNHIc3MohXVCKA2BeyQ4WeM2VCSC6wBZ6P0Yfkdzxv+87D8Xk0LJyHeCKlWMvpZt0g==";
      };
    };
...
in
{
  ...
  yaml-language-server = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "CzekVjFOUkiXI6tg3BPuSkxE60keDT4/+LjPLXwnt4gCRzaaWMCjT92NxOHv1derbBLHWoecay48tse/De181Q==";
    };
    dependencies = [
      sources."ajv-8.12.0"
      sources."fast-deep-equal-3.1.3"
